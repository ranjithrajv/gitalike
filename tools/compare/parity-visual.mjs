...
// A minimal 8-bit non-interlaced PNG reader (the shape Chromium screenshots
// take), so the tool needs no image dependency beyond Node's zlib.
...
// `crop` restricts the grid to a rectangle — the chrome band.
function lumaGrid(png, factor = 8, crop = null) {
...
// Global SSIM over the two luma grids.
function ssim(a, b) {
  const n = a.length;
  let ma = 0;
  let mb = 0;
